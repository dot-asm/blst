...
#  define sqr_n_mul_mont_383 sqra_n_mul_mont_383
#  define mul_384 mula_384
#  define sqr_384 sqra_384
#  define redc_mont_384 redca_mont_384
...
#if defined(__APX_F__) /* e.g. -mapxf */ && !defined(__BLST_PORTABLE__)
# define mul_mont_384x mula_mont_384x
# define sqr_mont_384x sqra_mont_384x
# define sqr_mont_382x sqra_mont_382x
# define mul_382x mula_382x
# define sqr_382x sqra_382x
#elif defined(__ADX__) /* e.g. -march=broadwell */ && !defined(__BLST_PORTABLE__)
